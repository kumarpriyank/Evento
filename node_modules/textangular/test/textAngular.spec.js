describe('textAngular', function () {
    ...
    describe('File Drop Event', function () {
        ...
        it('should respect the function set in the attribute', inject(function ($compile, $rootScope) {
            ...
            if (jQuery === angular.element) textAngularManager.retrieveEditor('test').scope.displayElements.text.triggerHandler({
                type: 'drop',
                originalEvent: {dataTransfer: {files: ['test'], types: ['files']}}
            });
            else textAngularManager.retrieveEditor('test').scope.displayElements.text.triggerHandler('drop', {
                originalEvent: {
                    dataTransfer: {
                        files: ['test'],
                        types: ['files']
        ...
        it('handler not fired when no files and no errors', inject(function ($compile, $rootScope, taOptions) {
            ...
            if (jQuery === angular.element) textAngularManager.retrieveEditor('test').scope.displayElements.text.triggerHandler({
                type: 'drop',
                originalEvent: {dataTransfer: {files: [], types: ['url or something']}}
            });
            else textAngularManager.retrieveEditor('test').scope.displayElements.text.triggerHandler('drop', {
                originalEvent: {
                    dataTransfer: {
                        files: [],
                        types: ['url or something']
                    }
                }
            });
            $rootScope.$digest();
    ...
    describe('handles the ta-paste event correctly', function () {
        ...
        it('allows conversion of html', inject(function ($window, _$rootScope_, $compile, $document, $timeout) {
            ...
            sel.setSingleRange(range);
            triggerEvent('paste', element, {
                originalEvent: {
                    clipboardData: {
                        types: ['text/html'], getData: function () {
