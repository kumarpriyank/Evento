...
<div id="ng-app" ng-app="textAngularDemo" ng-controller="demoController" class="ng-scope">
    <br>
    <div class="container">
        <a href="http://github.com/fraywing/textAngular"> <img src="http://textangular.com/images/textAngularLogo.png"
                                                               style="max-width:500%;" class="lighter"></a>
    ...
    <div class="container lighter">
        <div text-angular ng-model="htmlContent" name="demo-editor"
             ta-text-editor-class="clearfix border-around container" ta-html-editor-class="border-around"></div>
    </div>
    <br>
    ...
    <br>
    <div class="container border-around text-center lighter">
        <iframe src="http://ghbtns.com/github-btn.html?user=fraywing&amp;repo=textAngular&amp;type=watch&amp;size=large&amp;count=true"
                allowtransparency="true" frameborder="0" scrolling="0" width="220" height="30"></iframe>
        <iframe src="http://ghbtns.com/github-btn.html?user=fraywing&amp;repo=textAngular&amp;type=fork&amp;size=large"
                allowtransparency="true" frameborder="0" scrolling="0" width="180" height="30"></iframe>
        <iframe src="http://ghbtns.com/github-btn.html?user=fraywing&amp;repo=textAngular&amp;type=follow&amp;size=large"
                allowtransparency="true" frameborder="0" scrolling="0" width="180" height="30"></iframe>
    </div>
    <br>
    <div class="container">
