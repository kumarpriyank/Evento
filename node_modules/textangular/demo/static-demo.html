...
<div ng-app="textAngularTest" ng-controller="wysiwygeditor" class="container app">
    ...
    <form name="validationForm" ng-submit="submit()">
        ...
        <input type="url" tabindex="2" id="website" ng-model="website"> formValid: pristine
        {{validationForm.testValidation.$pristine}} valid {{validationForm.testValidation.$valid}} dirty
        {{validationForm.testValidation.$dirty}} invalid {{validationForm.testValidation.$invalid}} Bio:
        <text-angular name="testValidation" ta-paste="testPaste($html)" ng-if="canEdit" ng-model="data.htmlcontent"
                      tabindex="3" placeholder="test placeholder" required ta-disabled='disabled' ta-default-wrap="p"
                      ta-target-toolbars='htmlcontenttools,statictoolbar'
                      ng-model-options="{debounce: 1000}"></text-angular>
        <div ta-bind name="testValidation" ng-model="data.htmlcontent" placeholder="test placeholder" required
    ...
    <text-angular name="htmlcontent_nomodel">
        <p>Any <b>HTML</b> we put in-between the text-angular tags gets <a href="automatic">automatically</a> put into
            the editor if there <strong style="font-size: 12pt;"><u><em>is not</em></u></strong> a ngModel</p>
    </text-angular>
</div>
