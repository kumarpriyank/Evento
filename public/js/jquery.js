...
// Give the init function the jQuery prototype for later instantiation
    ...
    jQuery.ready.promise = function (obj) {
        if (!readyList) {
            ...
            // Catch cases where $(document).ready() is called after the browser events has already occurred.
...
// Detached nodes confoundingly followers *each other*
...
// Convert String-formatted options into Object-formatted ones and store in cache
    ...
    jQuery.support = (function (support) {
        ...
        // Support: IE<9 (lack submit/change bubble), Firefox 17+ (lack focusin events)
...
// Radios and checkboxes getter/setter
    ...
    jQuery.event = {
        ...
        dispatch: function (event) {
            ...
            while ((matched = handlerQueue[i++]) && !event.isPropagationStopped()) {
                ...
                while ((handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped()) {
                    ...
                    // Triggered events must either 1) have no namespace, or
                    // 2) have namespace(s) a subset or equal to those in the bound events (both can have no namespace).
        ...
        simulate: function (type, elem, event, bubble) {
            ...
            // simulated events prevents default then we do the same on the donor.
            var e = jQuery.extend(
                new jQuery.Event(),
                event,
                {
    ...
    jQuery.removeEvent = document.removeEventListener ?
        ...
        function (elem, type, handle) {
            ...
            if (elem.detachEvent) {
                ...
                // detachEvent needed property on element, by name of that events, to properly expose it to GC
...
// IE submit delegation
    if (!jQuery.support.submitBubbles) {
        ...
        jQuery.event.special.submit = {
            ...
            postDispatch: function (event) {
                // If form was submitted by the users, bubble the events up the tree
